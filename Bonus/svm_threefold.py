...
BONUS:          SVM with Threefold Cross Validation, Reduced samples
...
plt.title("Error Heat Map: svm_threefold")
...
u = svm.decision_function(X_test)
...
plt.title('ROC Curve: svm_threefold')
